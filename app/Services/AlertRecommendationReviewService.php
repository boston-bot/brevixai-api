...
class AlertRecommendationReviewService
{
    ...
    public function approve(
        ...
        return DB::transaction(function () use ($companyId, $userId, $recommendationId, $actorType, $businessProfileId): ?array {
            ...
            if (Schema::hasColumn('alerts', 'business_profile_id')) {
    ...
    private function lockedRecommendation(string $companyId, string $recommendationId, ?string $businessProfileId): ?AlertRecommendation
    {
        return AlertRecommendation::where('company_id', $companyId)
            ->where('id', $recommendationId)
            ->when(
                $businessProfileId && Schema::hasColumn('alert_recommendations', 'business_profile_id'),
